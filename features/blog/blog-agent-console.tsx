        ...
        {!socialStatus ? (
          ...
          <>
            <dl>
              ...
              <div><dt>Verified-article handoff</dt><dd>{socialStatus.staticSyndication.enabled ? "Every 15 minutes" : "Disabled"}</dd></div>
              <div><dt>Last handoff scan</dt><dd>{localDate(socialStatus.staticSyndication.lastScanAt)}</dd></div>
              <div><dt>Last handoff result</dt><dd>{socialStatus.staticSyndication.lastCode ?? "Not run"}</dd></div>
              ...
              <div><dt>Facebook last result</dt><dd>{socialStatus.channels.facebook.lastCode ?? "Not attempted"}</dd></div>
              ...
              <div><dt>Instagram last result</dt><dd>{socialStatus.channels.instagram.lastCode ?? "Not attempted"}</dd></div>
            </dl>
            <label>
